...
class EditTripScreen extends StatefulWidget {
  const EditTripScreen(
      {Key? key, required this.tripID, required this.tripModel})
      : super(key: key);
